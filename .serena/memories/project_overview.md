...
- **목적**: Spring Boot + Thymeleaf 기반 모노레포 웹 애플리케이션 (사용자/관리자)
- **시스템**: Darwin (macOS)
...
| security | JWT/Guard/블랙리스트 | 횡단 관심사, port/adapter 분리 |
...
- 앱 격리: `@ConditionalOnProperty(name = "app.type", havingValue = "user/admin")`
